 ...
 */
final class Version20250908091941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commandes ADD quantite INT DEFAULT NULL, ADD prix_unitaire NUMERIC(10, 2) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commandes DROP quantite, DROP prix_unitaire');
    }
}
